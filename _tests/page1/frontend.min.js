...
document.addEventListener('DOMContentLoaded', function () {
    var api = new jwtbutler({
        ...
        sso: ['https://example-auth-page1.local.vielhuber.de', 'https://example-auth-page2.local.vielhuber.de', 'https://example-auth-page3.local.vielhuber.de']
    });
    ...
    document.querySelector('.fetch1').addEventListener('click', function (e) {
        api.fetch('https://example-auth-page1.local.vielhuber.de/protected/', { method: 'GET' }).then(function (res) {
            return res.json();
    ...
    document.querySelector('.fetch2').addEventListener('click', function (e) {
        api.fetch('https://example-auth-page2.local.vielhuber.de/protected/', { method: 'GET' }).then(function (res) {
            return res.json();
        }).catch(function (error) {
            return error;
        }).then(function (response) {
    ...
    document.querySelector('.fetch3').addEventListener('click', function (e) {
        api.fetch('https://example-auth-page3.local.vielhuber.de/protected/', { method: 'GET' }).then(function (res) {
            return res.json();
        }).catch(function (error) {
            return error;
        }).then(function (response) {
