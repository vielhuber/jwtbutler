...
var helpers = function () {
    ...
    (0, _createClass3.default)(helpers, null, [{
        ...
        key: 'promiseWithoutError',
        value: function promiseWithoutError() {}
    }]);
    return helpers;
}();
...
},{"babel-runtime/helpers/classCallCheck":6,"babel-runtime/helpers/createClass":7}],2:[function(require,module,exports){
'use strict';
    ...
    (0, _createClass3.default)(ssohelper, [{
        ...
        value: function (_fetch) {
            ...
            return new _promise2.default(function (resolve, reject) {
                ...
                if (tries > 3) {
                    reject(null);
                    return;
                } else if (_this2.isLoggedIn() === false) {
                    _this2.login().then(function () {
                        _this2.fetch(url, args, tries + 1).then(function (response) {
                            resolve(response);
                        ...
                        if (response.status === undefined || response.status === 401) {
                            ...
                            fetch(_this2.config.auth_server + '/refresh', {
                                ...
                                if (response.success === true) {
                                    _this2.setCookies(response.data.access_token).then(function () {
        ...
        value: function setCookies() {
            ...
            return new _promise2.default(function (resolve) {
                if (_this4.setCookieLoading === undefined) {
                    _this4.setCookieLoading === false;
                }
                if (_this4.setCookieLoading === true) {
                    resolve();return;
                }
                ...
                _this4.setCookieLoading = true;
                var todo = _this4.config.pages.length - 1,
                    _this = _this4,
                    fn = function fn(e) {
                ...
                _this4.config.pages.forEach(function (pages__value) {
        ...
        value: function renderLoginFormWithPromise() {
            ...
            return new _promise2.default(function (resolve, reject) {
                _helpers2.default.remove(document.querySelector('.login_form'));
                ...
                form.addEventListener('submit', function (e) {
                    ...
                    _helpers2.default.remove(form.querySelector('.login_form__error'));
                    fetch(_this5.config.auth_server + '/login', {
                        method: 'POST',
                        ...
                        if (response.success === true) {
                            _helpers2.default.remove(document.querySelector('.login_form'));
                            _this5.setCookies(response.data.access_token).then(function () {
                                resolve();
                            }).catch(function (error) {
                                reject(error);
                            });
        ...
        value: function logout() {
            ...
            return new _promise2.default(function (resolve, reject) {
                fetch(_this6.config.auth_server + '/logout', {
                    method: 'POST',
                    headers: { 'content-type': 'application/json', 'Authorization': 'Bearer ' + _helpers2.default.cookieGet('access_token') },
                    cache: 'no-cache'
                }).then(function (res) {
                    ...
                    _this6.setCookies(null).then(function () {
                        resolve();
                    }).catch(function (error) {
                        reject(error);
                    });
...
},{"./_helpers":1,"babel-runtime/core-js/json/stringify":3,"babel-runtime/core-js/promise":5,"babel-runtime/helpers/classCallCheck":6,"babel-runtime/helpers/createClass":7}],3:[function(require,module,exports){
module.exports = { "default": require("core-js/library/fn/json/stringify"), __esModule: true };
},{"core-js/library/fn/json/stringify":8}],4:[function(require,module,exports){
...
},{"../../modules/_core":18,"../../modules/es6.object.define-property":74}],10:[function(require,module,exports){
...
},{"../modules/_core":18,"../modules/es6.object.to-string":75,"../modules/es6.promise":76,"../modules/es6.string.iterator":77,"../modules/es7.promise.finally":78,"../modules/es7.promise.try":79,"../modules/web.dom.iterable":80}],11:[function(require,module,exports){
...
},{"./_descriptors":21,"./_export":24,"./_object-dp":46}],75:[function(require,module,exports){
...
},{"./_iter-define":38,"./_string-at":61}],78:[function(require,module,exports){
...
},{"./_core":18,"./_export":24,"./_global":27,"./_promise-resolve":52,"./_species-constructor":60}],79:[function(require,module,exports){
'use strict';
...
},{"./_export":24,"./_new-promise-capability":44,"./_perform":51}],80:[function(require,module,exports){
...
},{"./_global":27,"./_hide":29,"./_iterators":41,"./_wks":71,"./es6.array.iterator":73}]},{},[2]);
